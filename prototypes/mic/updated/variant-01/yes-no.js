function radioClick(element, uncheckId, checkedImageId, uncheckedImageId) {
    ...
    document.getElementById(checkedImageId).setAttribute('src', '../core/img/radio-checked.svg');
    document.getElementById(uncheckId).classList.remove('checked');
    document.getElementById(uncheckedImageId).setAttribute('src', '../core/img/radio-unchecked.svg');

    if (element.id === 'yesLabel1') {
        var mpan = document.getElementById('mpan');
        mpan.value = 'MP 98237492673495';
